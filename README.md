...
- Bring the OnePlus 15 hardware platform up on a clean Linux `v6.12.23` baseline.
...
| Mainline baseline | Linux `v6.12.23` |
| OEM kernel generation | Android 16 / Linux `6.12.23` |
...
- Clean Linux `v6.12.23` source baseline established.
