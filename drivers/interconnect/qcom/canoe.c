...
static struct qcom_icc_node qsm_cfg = {
	...
	.buswidth = 4,
	.num_links = 35,
	.link_nodes = { &qhs_ahb2phy0, &qhs_ahb2phy1, &qhs_camera_cfg, &qhs_clk_ctl, &qhs_crypto0_cfg, &qhs_display_cfg, &qhs_eva_cfg, &qhs_gpuss_cfg, &qhs_i2c, &qhs_i3c_ibi0_cfg, &qhs_i3c_ibi1_cfg, &qhs_imem_cfg, &qhs_ipc_router, &qhs_mss_cfg, &qhs_pcie_cfg, &qhs_prng, &qhs_qdss_cfg, &qhs_qspi, &qhs_qup1, &qhs_qup2, &qhs_qup3, &qhs_qup4, &qhs_sdc2, &qhs_sdc4, &qhs_spss_cfg, &qhs_tcsr, &qhs_tlmm, &qhs_ufs_mem_cfg, &qhs_usb3, &qhs_venus_cfg, &qhs_vsense_ctrl_cfg, &qss_mnoc_cfg, &qss_pcie_anoc_cfg, &xs_qdss_stm, &xs_sys_tcu_cfg },
};
...
static struct qcom_icc_node qnm_gemnoc_cnoc = {
	...
	.buswidth = 16,
	.num_links = 10,
	.link_nodes = { &qhs_aoss, &qhs_ipa, &qhs_ipc_router_fence, &qhs_soccp, &qhs_tme_cfg, &qns_apss, &qss_cfg, &qss_ddrss_cfg, &qxs_boot_imem, &qxs_imem },
};
