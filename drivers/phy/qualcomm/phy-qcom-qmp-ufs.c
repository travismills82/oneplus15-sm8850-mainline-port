...
static const struct qmp_phy_init_tbl canoe_ufsphy_serdes[] = {
	QMP_PHY_INIT_CFG(QSERDES_V6_COM_SYSCLK_EN_SEL, 0xd9),
	QMP_PHY_INIT_CFG(QSERDES_V6_COM_CMN_CONFIG_1, 0x16),
	QMP_PHY_INIT_CFG(QSERDES_V6_COM_HSCLK_SEL_1, 0x11),
	QMP_PHY_INIT_CFG(QSERDES_V6_COM_HSCLK_HS_SWITCH_SEL_1, 0x00),
...
static const struct qmp_phy_init_tbl canoe_ufsphy_tx[] = {
...
static const struct qmp_phy_init_tbl canoe_ufsphy_rx[] = {
...
static const struct qmp_phy_init_tbl canoe_ufsphy_pcs[] = {
	QMP_PHY_INIT_CFG(QPHY_V6_PCS_UFS_MULTI_LANE_CTRL1, 0x02),
	QMP_PHY_INIT_CFG(QPHY_V6_PCS_UFS_TX_MID_TERM_CTRL1, 0x43),
...
static const struct qmp_phy_init_tbl canoe_ufsphy_g4_pcs[] = {
	QMP_PHY_INIT_CFG(QPHY_V6_PCS_UFS_TX_HSGEAR_CAPABILITY, 0x04),
	QMP_PHY_INIT_CFG(QPHY_V6_PCS_UFS_RX_HSGEAR_CAPABILITY, 0x04),
};

static const struct qmp_phy_init_tbl canoe_ufsphy_g5_pcs[] = {
...
static const struct qmp_phy_init_tbl canoe_ufsphy_hs_b_pcs[] = {
...
static const struct qmp_phy_cfg canoe_ufsphy_cfg = {
	.lanes			= 2,
	...
	.tbls = {
		.serdes		= canoe_ufsphy_serdes,
		.serdes_num	= ARRAY_SIZE(canoe_ufsphy_serdes),
		.tx		= canoe_ufsphy_tx,
		.tx_num		= ARRAY_SIZE(canoe_ufsphy_tx),
		.rx		= canoe_ufsphy_rx,
		.rx_num		= ARRAY_SIZE(canoe_ufsphy_rx),
		.pcs		= canoe_ufsphy_pcs,
		.pcs_num	= ARRAY_SIZE(canoe_ufsphy_pcs),
	},
	.tbls_hs_b = {
		.pcs		= canoe_ufsphy_hs_b_pcs,
		.pcs_num	= ARRAY_SIZE(canoe_ufsphy_hs_b_pcs),
	},
	.tbls_hs_overlay[0] = {
		.pcs		= canoe_ufsphy_g4_pcs,
		.pcs_num	= ARRAY_SIZE(canoe_ufsphy_g4_pcs),
		.max_gear	= UFS_HS_G4,
	},
	.tbls_hs_overlay[1] = {
		.pcs		= canoe_ufsphy_g5_pcs,
		.pcs_num	= ARRAY_SIZE(canoe_ufsphy_g5_pcs),
		.max_gear	= UFS_HS_G5,
	},

	.vreg_list		= canoe_ufsphy_vreg_l,
	.num_vregs		= ARRAY_SIZE(canoe_ufsphy_vreg_l),
	.regs			= ufsphy_v6_regs_layout,
};
